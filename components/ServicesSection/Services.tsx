          ...
          >
            ...
            {/* <motion.div className="absolute inset-0">
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute w-4 h-4 rounded-full bg-gradient-to-r from-purple-500 to-blue-500"
                  animate={{
            ...
            >
              <Image
                ...
                width={727}
                height={727}
                className="object-contain relative z-10 w-[80%] md:w-full max-w-[727px]"
                style={{
                  filter: "drop-shadow(0px 20px 50px rgba(112, 28, 192, 0.3))",
                }}
              />
            </motion.div>
          </motion.div>
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                {/* Floating Shape for Active Service */}
              </div>
            );
          })}
        </div>
